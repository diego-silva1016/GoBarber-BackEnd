...
var CreateAppointmentSevice_1 = __importDefault(require("../services/CreateAppointmentSevice"));
...
appointmentsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, provider, date, parseDate, CreateAppointment, appointment, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                CreateAppointment = new CreateAppointmentSevice_1.default();
